...
public class ProblemServiceImpl implements ProblemService {
  ...
  @Override
  @Transactional
  public ProblemResponseDto addProblem(ProblemAddRequestDto problemAddRequestDto, List<MultipartFile> inputTestcases, List<MultipartFile> outputTestcases, List<Boolean> isPublics, List<MultipartFile> problemImages) {
